...
public class OnCrack : MonoBehaviour {
  ...
  public void Jump()
  {
    ...
    body.velocity = new Vector2(gameObject.GetComponent<Rigidbody2D>().velocity.x, JumpForce);
  }
  ...
  void FixedUpdate () {
    ...
    Rigidbody2D body = gameObject.GetComponent<Rigidbody2D>();
    if (isGrounded)
      body.velocity = new Vector2(WalkingSpeed * move.x,body.velocity.y);
